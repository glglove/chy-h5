...
<template>
    <container ref="containerCmp">
        <view id="approvalFlow" slot="container-slot" class="page animated fadeInLeft fast">
            <view class="catTit">
                常用
            </view>
...
export default  {
    mixins: [
        MescrollMixin,
        miniProApi
    ], // 这里一定需要 MescrollMixin 放在 miniProApi前面 否则上/下拉刷新不会生效，因为此时 还没有初始化mescorll
    data(){
        return {
